<?php 
    ...
    && !empty($_POST['tel']) && !empty($_POST['modele_de_vehicule'])&& !empty($_POST['message'])){
        $surname = htmlspecialchars($_POST['surname']);
        $firstname = htmlspecialchars($_POST['firstname']);
        $email = htmlspecialchars($_POST['email']);
        $tel = htmlspecialchars($_POST['tel']);
        $modele_de_vehicule = htmlspecialchars($_POST['modele_de_vehicule']);
        $date_p = htmlspecialchars($_POST['date_p']);
        $date_r = htmlspecialchars($_POST['date_r']);
        ...
        $body = [
            ...
            [
                ...
                'TextPart' => "$email, $tel, $modele_de_vehicule, $date_p, $date_r, $message ", 
